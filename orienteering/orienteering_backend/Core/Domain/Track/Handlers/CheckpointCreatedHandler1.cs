...
public class CheckpointCreatedHandler1 : INotificationHandler<CheckpointCreated>
{
    private readonly OrienteeringContext _db;
    private readonly IMediator _mediator;
    public CheckpointCreatedHandler1(OrienteeringContext db, IMediator mediator)
    {
