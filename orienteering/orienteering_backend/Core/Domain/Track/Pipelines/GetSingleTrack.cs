...
public static class GetSingleTrack
{
    public record Request(
        Guid trackId) : IRequest<Track>;
    //Guid UserId) : IRequest<List<Track>>;


    public class Handler : IRequestHandler<Request, Track>
    //public class Handler : IRequestHandler<Request, List<Track>>
    {
        ...
        public async Task<Track> Handle(Request request, CancellationToken cancellationToken)
